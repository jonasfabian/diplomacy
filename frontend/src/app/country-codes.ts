export class CountryCodes {
  countries = [{'name': 'Afghanistan', 'countryCode': 'AF'},
    {'name': 'Ã…land Islands', 'countryCode': 'AX'},
    ...
    {'name': 'CÃ´te d\'Ivoire', 'countryCode': 'CI'},
    {'name': 'Croatia', 'countryCode': 'HR'},
    {'name': 'Cuba', 'countryCode': 'CU'},
    {'name': 'CuraÃ§ao', 'countryCode': 'CW'},
