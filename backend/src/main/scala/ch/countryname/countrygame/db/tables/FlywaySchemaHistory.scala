...
)
{
  ...
  def this(alias : String) = {
    this(DSL.name(alias), null, null, ch.countryname.countrygame.db.tables.FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, null)
  }

  def this(alias : Name) = {
    this(alias, null, null, ch.countryname.countrygame.db.tables.FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, null)
  }
  ...
  def this(child : Table[_ <: Record], key : ForeignKey[_ <: Record, FlywaySchemaHistoryRecord]) = {
    this(Internal.createPathAlias(child, key), child, key, ch.countryname.countrygame.db.tables.FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, null)
  }
